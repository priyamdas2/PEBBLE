...
setwd("U:/PEBBLE/Final Simulation study/Scenario 6")
...
write.csv(SUMMARY_MAT_approx, paste0("Scenario_6_SummaryALL_mat_nBOOT_",num_BOOT,"_nexp_",Num_of_exp,"_n_",n,"_p_",p,"_seed_",seed_no,".csv"))
}
# Width_Pebble
...
write.csv(OUTPUT_X0, paste0("Scenario_6_Summary_X0_T_star_nBOOT_",num_BOOT,"_nexp_",Num_of_exp,"_n_",n,"_p_",p,"_seed_",seed_no,".csv"))
