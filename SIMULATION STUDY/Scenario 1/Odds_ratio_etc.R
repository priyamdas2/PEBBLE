...
setwd("D:/Logistic regression Project/Odds_ratio_and_new_simulation_study")
...
write.csv(SUMMARY_MAT_approx, paste0("SummaryALL_mat_nBOOT_",num_BOOT,"_nexp_",Num_of_exp,"_n_",n,"_p_",p,"_c_",c,"_seed_",seed_no,".csv"))
}
# Width_Pebble
...
write.csv(OUTPUT_X0, paste0("Summary_X0_T_star_nBOOT_",num_BOOT,"_nexp_",Num_of_exp,"_n_",n,"_p_",p,"_c_",c,"_seed_",seed_no,".csv"))
